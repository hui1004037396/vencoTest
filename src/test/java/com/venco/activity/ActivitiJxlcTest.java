...
import com.venco.activity.ActivityApplication;

import com.venco.activity.entity.Person;

import com.venco.activity.service.impl.ActivityDemoServiceImpl;
import com.venco.activity.service.impl.ActivityJxlcServiceImpl;
...
public class ActivitiJxlcTest {

	@Resource

	private ActivityJxlcServiceImpl activityJxlcServiceImpl;
	...
	public void startPro() {
		...
		variables.put("targetMaker", "venco");
		variables.put("targetApprove", "wl");
		variables.put("firstScore", "wl");
		variables.put("secondScore", "hrManager");
		variables.put("finalScore", "BOSS");
		
		activityJxlcServiceImpl.startProcesses("jxId5",variables);
	...
	public void startAndCommit() {
		...
		activityJxlcServiceImpl.startAndCommit("jxId5",variables);
	...
	public void findTasksForSL() {
		...
		List<Task> lists = activityJxlcServiceImpl.findTasksByUserId("venco");
	...
	public void completeTasksForSL() {
		...
		activityJxlcServiceImpl.completeTask("42503", "wl", "false");//受理后，任务列表数据减少
	...
	public void findTasksForSP() {
		...
		List<Task> lists = activityJxlcServiceImpl.findTasksByUserId("spy1");
	...
	public void completeTasksForSP() {
		...
		activityJxlcServiceImpl.completeTask("12504", "spy1", "true");//审批后，任务列表数据减少
	...
	public void setTasksVar() {
		...
		List<Task> lists = activityJxlcServiceImpl.findTasksByUserId("sly1");
	...
	public void queryProImg() throws Exception {
		...
		activityJxlcServiceImpl.queryProImg("232501");
	...
	public void queryProHighLighted() throws Exception {
		...
		activityJxlcServiceImpl.queryProHighLighted("232501");
